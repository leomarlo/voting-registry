...
export interface ThresholdTokenVoteInterface extends utils.Interface {
  functions: {
...
export interface ThresholdTokenVote extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: ThresholdTokenVoteInterface;
