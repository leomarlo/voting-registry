...
export interface SimpleMajorityVoteInterface extends utils.Interface {
  functions: {
...
export interface SimpleMajorityVote extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: SimpleMajorityVoteInterface;
