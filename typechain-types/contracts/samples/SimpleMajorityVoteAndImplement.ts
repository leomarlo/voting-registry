...
export interface SimpleMajorityVoteAndImplementInterface
...
export interface SimpleMajorityVoteAndImplement extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: SimpleMajorityVoteAndImplementInterface;
