...
export interface CanVoteAndDelegateImplementInterface extends utils.Interface {
  functions: {
...
export interface CanVoteAndDelegateImplement extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: CanVoteAndDelegateImplementInterface;
