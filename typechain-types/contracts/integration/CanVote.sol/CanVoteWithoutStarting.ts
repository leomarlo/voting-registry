...
export interface CanVoteWithoutStartingInterface extends utils.Interface {
  functions: {
...
export interface CanVoteWithoutStarting extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: CanVoteWithoutStartingInterface;
