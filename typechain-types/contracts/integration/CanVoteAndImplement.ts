...
export interface CanVoteAndImplementInterface extends utils.Interface {
  functions: {
...
export interface CanVoteAndImplement extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: CanVoteAndImplementInterface;
