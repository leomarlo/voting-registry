...
export interface VoteContractPrimitiveInterface extends utils.Interface {
  functions: {
...
export interface VoteContractPrimitive extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: VoteContractPrimitiveInterface;
