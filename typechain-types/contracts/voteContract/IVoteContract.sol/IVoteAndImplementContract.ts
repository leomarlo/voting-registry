...
export interface IVoteAndImplementContractInterface extends utils.Interface {
  functions: {
...
export interface IVoteAndImplementContract extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: IVoteAndImplementContractInterface;
